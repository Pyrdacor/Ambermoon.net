...
namespace Ambermoon.Render
{
    internal class Credits
    {
        ...
        public Credits(IGameRenderView renderView, Layout layout, Action<Action> finishAction)
        {
            ...
            AddText("timbo t");
            AddText("Anton Huber");
            AddText("Lars Haugseth");
            AddText("giom");
            AddText("MD");
            AddText("Daniel Egger");
            AddText("Kaspar");
            AddText("Wolfgang Dobmeier");
            AddText("NLS");
            ...
            AddText("Thanks to all the project contributors on github.", 1);
            AddText("Hessi9b, rap2hpoutre, ReddestDream, midwan, TheYoctoJester,");
            AddText("sisch, cbrueffer, claasd and of course Metibor. :)");
