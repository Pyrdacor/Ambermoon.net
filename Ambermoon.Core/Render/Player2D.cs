...
namespace Ambermoon.Render
{
    internal class Player2D : Character2D
    {
        ...
        public Player2D(Player player, RenderMap map, ISpriteFactory spriteFactory, IGameData gameData)
            : base(TextureAtlasManager.Instance.GetOrCreate(Layer.Player), spriteFactory, gameData.PlayerAnimationInfo, map.Map, new Position())
        {
            this.player = player;
            renderMap = map;
        }
