...
namespace Ambermoon.Render
{
    public class Color : IEquatable<Color>, IEqualityComparer<Color>
    {
        ...
        public static readonly Color Green = new(0x73, 0xb3, 0x43);
        public static readonly Color White = new(0xff, 0xff, 0xff);
        public static readonly Color DarkShadow = new(0x22, 0x22, 0x11);
        public static readonly Color DarkGray = new(0x44, 0x44, 0x33);
        public static readonly Color LightGray = new(0x66, 0x66, 0x55);
