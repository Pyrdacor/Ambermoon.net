        ...
        public GraphicProvider(GameData gameData, ExecutableData.ExecutableData executableData)
        {
            ...
            Palettes.Add(51, new Graphic
            {
                ...
                Data = new byte[]
                {
                    ...
                    // pale red (wait hour message outdoor), pale yellow (wait hour message indoor), azure (wait hour message 3D), rest unused
                    0xbb, 0x77, 0x55, 0xff, 0xcc, 0xaa, 0x44, 0xff, 0x00, 0xcc, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00,
