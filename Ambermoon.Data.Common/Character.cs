	...
	public abstract class Character
    {
        ...
        public bool IsImmuneToSpell(Spell spell, out bool silent, bool supportElements)
        {
            ...
            return spell switch
            {
				...
				Spell.RecognizeWeakPoint => Element == CharacterElement.Mental,
				Spell.SeeWeaknesses => Element == CharacterElement.Mental,
				Spell.KnowledgeOfTheWeakness => Element == CharacterElement.Mental,
				Spell.MysticDecay => Element == CharacterElement.Mental,
                Spell.ElementToEarth => boss || Element == CharacterElement.Earth,
                Spell.ElementToWind => boss || Element == CharacterElement.Wind,
                Spell.ElementToFire => boss || Element == CharacterElement.Fire,
                Spell.ElementToWater => boss || Element == CharacterElement.Water,
