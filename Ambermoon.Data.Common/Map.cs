...
namespace Ambermoon.Data
{
    ...
    public class Map
    {
        ...
        public interface IEventOnMap
        {
            uint MapEventId { get; set; }
        }

        public class Tile : IEventOnMap
        {
            /// <summary>
        ...
        public class Block : IEventOnMap
        {
        ...
        public class CharacterReference
        {
            ...
            public bool HourMovement => Type != CharacterType.Monster && CharacterFlags.HasFlag(Flags.HourMovement);
