...
namespace Ambermoon.Data
{
    ...
    public static class SpellInfos
    {
        static readonly Dictionary<Spell, SpellInfo> entries = new Dictionary<Spell, SpellInfo>
        {
            ...
            { Spell.Lame, new SpellInfo { SP = 10, SLP = 5, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Poison, new SpellInfo { SP = 15, SLP = 5, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Petrify, new SpellInfo { SP = 60, SLP = 5, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.CauseDisease, new SpellInfo { SP = 15, SLP = 5, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.CauseAging, new SpellInfo { SP = 15, SLP = 5, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Irritate, new SpellInfo { SP = 10, SLP = 5, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.CauseMadness, new SpellInfo { SP = 30, SLP = 10, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Sleep, new SpellInfo { SP = 15, SLP = 10, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Fear, new SpellInfo { SP = 50, SLP = 10, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Blind, new SpellInfo { SP = 15, SLP = 10, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Drug, new SpellInfo { SP = 15, SLP = 10, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } }, // TODO: sp/slp
            { Spell.DissolveVictim, new SpellInfo { SP = 250, SLP = 25, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Mudsling, new SpellInfo { SP = 8, SLP = 1, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Rockfall, new SpellInfo { SP = 15, SLP = 5, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Earthslide, new SpellInfo { SP = 20, SLP = 10, Target = SpellTarget.EnemyRow, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Earthquake, new SpellInfo { SP = 30, SLP = 15, Target = SpellTarget.AllEnemies, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Winddevil, new SpellInfo { SP = 12, SLP = 5, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Windhowler, new SpellInfo { SP = 25, SLP = 10, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Thunderbolt, new SpellInfo { SP = 35, SLP = 15, Target = SpellTarget.EnemyRow, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Whirlwind, new SpellInfo { SP = 50, SLP = 20, Target = SpellTarget.AllEnemies, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Firebeam, new SpellInfo { SP = 25, SLP = 10, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Fireball, new SpellInfo { SP = 60, SLP = 15, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Firestorm, new SpellInfo { SP = 80, SLP = 20, Target = SpellTarget.EnemyRow, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Firepillar, new SpellInfo { SP = 120, SLP = 25, Target = SpellTarget.AllEnemies, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Waterfall, new SpellInfo { SP = 50, SLP = 15, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Iceball, new SpellInfo { SP = 100, SLP = 20, Target = SpellTarget.SingleEnemy, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Icestorm, new SpellInfo { SP = 150, SLP = 25, Target = SpellTarget.EnemyRow, ApplicationArea = SpellApplicationArea.BattleOnly } },
            { Spell.Iceshower, new SpellInfo { SP = 200, SLP = 30, Target = SpellTarget.AllEnemies, ApplicationArea = SpellApplicationArea.BattleOnly } },
            // Special spells
