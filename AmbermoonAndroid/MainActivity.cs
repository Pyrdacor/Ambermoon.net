...
public class MainActivity : SilkActivity, GestureDetector.IOnGestureListener
{
    ...
    private ConsoleOverlayManager console;
    private EditText hiddenEditText;
    private string lastInputText = "";
    private readonly Handler longPressHandler;
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        gameWindow = new(RunOnUiThread, $"Ambermoon V{version}",
            (keyboardRequested, text) =>
            {
    ...
    protected override void OnRun()
    {
        ...
        try
        {
            ...
            gameWindow.Closed += () =>
            {
                // Finally won't be called if we kill the process. ;)
