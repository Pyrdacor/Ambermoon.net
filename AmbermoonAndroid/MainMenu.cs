...
namespace AmbermoonAndroid
{
    class MainMenu
    {
        ...
        Fader fader;
        Fader mainMenuFader;
        Ambermoon.UI.UIText loadingText;
            ...
            Action<Song> playMusicAction, bool showLogo)
        {
            ...
            loadingText = new Ambermoon.UI.UIText(renderView, renderView.GraphicProvider.SecondaryUIPaletteIndex, text,
            ...
            if (showLogo)
            {
                ...
                cursor.Type = Ambermoon.Data.CursorType.Sword;                
