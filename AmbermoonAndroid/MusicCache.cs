...
namespace AmbermoonAndroid
{
    internal class MusicCache : ISongManager
    {
        ...
        static readonly Song[] Songs = Ambermoon.Enum.GetValues<Song>().Skip(1).ToArray();
        readonly CachedSongPlayer cachedSongPlayer = new CachedSongPlayer();
        const string CacheFileName = "music.cache";
        Ambermoon.Data.Legacy.Audio.SongManager songManager = null;
        ...
        public MusicCache(IGameData gameData, Song? immediateLoadSongIndex, params string[] searchPaths)
        {
            ...
            // No cache found
            songManager = new Ambermoon.Data.Legacy.Audio.SongManager(gameData, immediateLoadSongIndex);
...
#pragma warning restore CS0675
        ...
        public static void Cache(ISongManager songManager, params string[] possiblePaths)
        {
            void Write(Stream stream)
            {
                foreach (var song in Songs)
                {
                    ...
                    if (songData is Ambermoon.Data.Legacy.Audio.ISongDataProvider songDataProvider)
        ...
        class CachedSong : ISong, Ambermoon.Data.Legacy.Audio.ISongDataProvider
        {
