...
if ($isWindows) {
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Any CPU/Release/net9.0/win-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList 'versions','"./Ambermoon.net/versions.dat"','diffs','./Ambermoon.net/diffs.dat','"./Ambermoon.net/bin/Any CPU/Release/net9.0/win-x64/publish/Ambermoon.net.exe"'
  cmd /c copy "Ambermoon.net\bin\Any CPU\Release\net9.0\win-x64\publish\Ambermoon.net.exe" "Ambermoon.net\Ambermoon.net.exe"
  7z a Ambermoon.net-Windows.zip "./Ambermoon.net/Ambermoon.net.exe" "./AmbermoonPatcher/bin/Any CPU/Release/net9.0/win-x64/publish/AmbermoonPatcher.exe" "./Ambermoon.net/x64/api-ms-win-core-winrt-l1-1-0.dll" "./Package/*" -mx9
  New-Item -ItemType Directory -Name "dist"
  Copy-Item -Path ".\AmbermoonPatcher\bin\Any CPU\Release\net9.0\win-x64\publish\AmbermoonPatcher.exe" -Destination "dist\"
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Any CPU/Release/net9.0/win-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList 'versions','"./Ambermoon.net/versions.dat"','diffs','./Ambermoon.net/diffs.dat','"./Ambermoon.net/bin/Any CPU/Release/net9.0/win-x86/publish/Ambermoon.net.exe"'
  cmd /c copy "Ambermoon.net\bin\Any CPU\Release\net9.0\win-x86\publish\Ambermoon.net.exe" "Ambermoon.net\Ambermoon.net.exe"
  7z a Ambermoon.net-Windows32Bit.zip "./Ambermoon.net/Ambermoon.net.exe" "./AmbermoonPatcher/bin/Any CPU/Release/net9.0/win-x86/publish/AmbermoonPatcher.exe" "./Ambermoon.net/x86/api-ms-win-core-winrt-l1-1-0.dll" "./Package/*" -mx9
  $scriptPath = "InnoSetupScript.iss"
  $scriptContent = Get-Content $scriptPath -Raw
  $versionWithoutPrefix = $env:APPVEYOR_REPO_TAG_NAME -replace '^v'
  ...
  Write-Host **** modified script content ****
  Write-Host $newScriptContent
  & "C:\Program Files (x86)\Inno Setup 6\ISCC.exe" "/O." $newScriptPath
} elseif ($isLinux) {
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Any CPU/Release/net9.0/linux-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList 'versions','"./Ambermoon.net/versions.dat"','diffs','./Ambermoon.net/diffs.dat','"./Ambermoon.net/bin/Any CPU/Release/net9.0/linux-x64/publish/Ambermoon.net"'
  7z a Ambermoon.net-Linux.tar "./Ambermoon.net/bin/Any CPU/Release/net9.0/linux-x64/publish/Ambermoon.net" "./AmbermoonPatcher/bin/Any CPU/Release/net9.0/linux-x64/publish/AmbermoonPatcher" "./Package/*"
  ...
  cp "./Ambermoon.net/bin/Any CPU/Release/net9.0/osx-x64/publish/Ambermoon.net" ./bundle/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/
  ...
  cp "./Ambermoon.net/bin/Any CPU/Release/net9.0/osx-arm64/publish/Ambermoon.net" ./bundle-arm/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/
