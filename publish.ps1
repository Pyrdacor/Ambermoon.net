...
if ($winbuild) {
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Release/netcoreapp3.1/linux-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList '"./versions.dat"','"./Ambermoon.net/bin/Release/netcoreapp3.1/linux-x64/publish/Ambermoon.net"'
  7z a Ambermoon.net-Linux.tar "./Ambermoon.net/bin/Release/netcoreapp3.1/linux-x64/publish/Ambermoon.net"
