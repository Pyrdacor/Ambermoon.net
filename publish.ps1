...
if ($isWindows) {
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Any CPU/Release/net8.0/win-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList 'versions','"./Ambermoon.net/versions.dat"','diffs','./Ambermoon.net/diffs.dat','"./Ambermoon.net/bin/Any CPU/Release/net8.0/win-x64/publish/Ambermoon.net.exe"'
  cmd /c copy "Ambermoon.net\bin\Any CPU\Release\net8.0\win-x64\publish\Ambermoon.net.exe" "Ambermoon.net\Ambermoon.net.exe"
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Any CPU/Release/net8.0/win-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList 'versions','"./Ambermoon.net/versions.dat"','diffs','./Ambermoon.net/diffs.dat','"./Ambermoon.net/bin/Any CPU/Release/net8.0/win-x86/publish/Ambermoon.net.exe"'
  cmd /c copy "Ambermoon.net\bin\Any CPU\Release\net8.0\win-x86\publish\Ambermoon.net.exe" "Ambermoon.net\Ambermoon.net.exe"
  ...
  cp "./Ambermoon.net/bin/Any CPU/Release/net8.0/osx-x64/publish/Ambermoon.net" ./bundle/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/
  ...
  cp "./Ambermoon.net/bin/Any CPU/Release/net8.0/osx-arm64/publish/Ambermoon.net" ./bundle-arm/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/
