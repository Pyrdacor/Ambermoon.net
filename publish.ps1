...
if ($isWindows) {
  ...
  cmd /c copy /b "Ambermoon.net\bin\Any CPU\Release\netcoreapp3.1\win-x64\publish\Ambermoon.net.exe"+"Ambermoon.net\versions.dat" "Ambermoon.net\Ambermoon.net.exe"
  7z a Ambermoon.net-Windows.zip "Ambermoon.net\Ambermoon.net.exe"
  cmd /c copy /b "Ambermoon.net\bin\Any CPU\Release\netcoreapp3.1\win-x86\publish\Ambermoon.net.exe"+"Ambermoon.net\versions.dat" "Ambermoon.net\Ambermoon.net.exe"
  ...
  cat "./Ambermoon.net/bin/Any CPU/Release/netcoreapp3.1/linux-x64/publish/Ambermoon.net" "./Ambermoon.net/versions.dat" > "./Ambermoon.net/Ambermoon.net"
