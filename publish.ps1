...
if ($isWindows) {
  ...
  cmd /c copy /b "Ambermoon.net\bin\Any CPU\Release\net6\win-x64\publish\Ambermoon.net.exe"+"versions.dat" "Ambermoon.net\Ambermoon.net.exe"
  7z a Ambermoon.net-Windows.zip "Ambermoon.net\Ambermoon.net.exe"
  7z a Ambermoon.net-Windows.zip "Ambermoon.net\bin\Any CPU\Release\net6\win-x64\publish\api-ms-win-core-winrt-l1-1-0.dll"
  cmd /c copy /b "Ambermoon.net\bin\Any CPU\Release\net6\win-x86\publish\Ambermoon.net.exe"+"versions.dat" "Ambermoon.net\Ambermoon.net.exe"
  7z a Ambermoon.net-Windows32Bit.zip "Ambermoon.net\Ambermoon.net.exe"
  7z a Ambermoon.net-Windows32Bit.zip "Ambermoon.net\bin\Any CPU\Release\net6\win-x86\publish\api-ms-win-core-winrt-l1-1-0.dll"
} elseif ($isLinux) {
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Any CPU/Release/net6/linux-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList '"./versions.dat"','"./Ambermoon.net/bin/Any CPU/Release/netcoreapp3.1/linux-x64/publish/Ambermoon.net"'
  7z a Ambermoon.net-Linux.tar "./Ambermoon.net/bin/Any CPU/Release/net6/linux-x64/publish/Ambermoon.net"
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Any CPU/Release/net6/osx-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList '"./versions.dat"','"./Ambermoon.net/bin/Any CPU/Release/netcoreapp3.1/osx-x64/publish/Ambermoon.net"'
  7z a Ambermoon.net-Mac.zip "./Ambermoon.net/bin/Any CPU/Release/net6/osx-x64/publish/Ambermoon.net"
  mkdir -p ./bundle/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/
  cp -r ./Ambermoon.net/Mac/* ./bundle/Ambermoon.net/
  cp "./Ambermoon.net/bin/Any CPU/Release/net6/osx-x64/publish/Ambermoon.net" ./bundle/Ambermoon.net/Ambermoon.net.app/Contents/MacOS/
