...
if ($isWindows) {
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Any CPU/Release/net6.0/linux-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList '"./versions.dat"','"./Ambermoon.net/bin/Any CPU/Release/netcoreapp3.1/linux-x64/publish/Ambermoon.net"'
  ...
  Start-Process -FilePath "./Ambermoon.ConcatFiles/bin/Any CPU/Release/net6.0/osx-x64/publish/Ambermoon.ConcatFiles" -Wait -WorkingDirectory . -ArgumentList '"./versions.dat"','"./Ambermoon.net/bin/Any CPU/Release/netcoreapp3.1/osx-x64/publish/Ambermoon.net"'
  7z a Ambermoon.net-Mac.zip "./Ambermoon.net/bin/Any CPU/Release/net6.0/osx-x64/publish/Ambermoon.net"
